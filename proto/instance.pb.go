...
var file_instance_proto_depIdxs = []int32{
	...
	1, // 2: proto.InstanceService.CreateInstance:output_type -> proto.CreateInstanceResponse
	3, // 3: proto.InstanceService.GetInstanceInfo:output_type -> proto.InstanceInfoResponse
